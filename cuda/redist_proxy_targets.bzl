...
REPO_PUBLIC_TARGETS = {
    ...
    "cuda_cufile": ["cufile_shared_library", "cufile_interface_library", "cufile_static_library", "cufile", "cufile_system", "cufile_static", "header_list", "headers", "shared_library_files"],
