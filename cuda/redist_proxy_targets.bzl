...
REPO_PUBLIC_TARGETS = {
    ...
    "cuda_tensorrt": [
        "nvinfer_shared_library",
        "nvinfer_interface_library",
        "nvinfer",
        "nvinfer_system",
        "nvinfer_plugin_shared_library",
        "nvinfer_plugin_interface_library",
        "nvinfer_plugin",
        "nvinfer_plugin_system",
        "nvonnxparser_shared_library",
        "nvonnxparser_interface_library",
        "nvonnxparser_static_library",
        "nvonnxparser",
        "nvonnxparser_system",
        "nvonnxparser_static",
        "header_list",
